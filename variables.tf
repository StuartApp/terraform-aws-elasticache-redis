...
variable "elasticache_security_group_name" {
  type        = string
  description = "Security group name for the ElastiCache instance"
  default     = ""
}

variable "elasticache_parameter_group_name" {
  type        = string
  description = "Parameter group name for the ElasticCache instance"
  default     = ""
}

variable "cloudwatch_metric_alarm_name_prefix" {
  type        = string
  description = "Prefix for CloudWatch metric alarm names"
  default     = ""
}

variable "dns_name" {
  type        = string
  description = "DNS name that will point to the ElasticCache instance"
  default     = ""
}
